...
```{r}
#look at idents; change idents to cell_type; check idents again
head(Idents(cogimp))
...
```{r}
#create an object that has the iformation for differential expression of genes between one cell type and all others
markers1 <- FindMarkers(cogimp,  ident.1 = "Tem/Effector helper T cells", ident.2 = NULL, assay="RNA", test.use = "MAST")

#use that object to create a volcano plot
